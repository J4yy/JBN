...
<div class="table-responsive">
    <table class="table table-striped table-bordered table-hover">
        ...
        <thead>
            <tr>
                <th class="text-center">{LANG.subject_code}</th>
                <th class="text-center">{LANG.subject_name}</th>
                <th class="text-center">{LANG.type}</th>
                <th class="text-center">{LANG.suggestions}</th>
        ...
        <tbody id="block-list-container">
            ...
            <tr id="block-row-{ROW.bid}">
                ...
                <td class="text-center">{ROW.suggestions}</td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">{LANG.block_add_subject}</h3>
            </div>
            <div class="modal-body">
                <form class="form-horizontal">
                    <div class="form-group">
                        <label for="subject_code" class="col-sm-5 control-label">{LANG.subject_code}</label>
                        <div class="col-sm-19">
                            <input type="text" class="form-control txt" id="subject_code" name="subject_code">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="subject_name" class="col-sm-5 control-label">{LANG.subject_name}</label>
                        <div class="col-sm-19">
                            <input type="text" name="subject_name" id="subject_name" class="form-control txt" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="type" class="col-sm-5 control-label">{LANG.type}</label>
                        <div class="col-sm-19">
                            <input type="text" class="form-control txt" id="type" name="type">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="suggestions" class="col-sm-5 control-label">{LANG.suggestions}</label>
                        <div class="col-sm-19">
                            <input type="text" class="form-control txt" id="suggestions" name="suggestions">
                        </div>
                    </div>
...
<div class="clearfix" style="text-align:center;">
    <button  class="btn btn-primary block-add-trigger pull-center">{LANG.button_subject}</button>
</div>
<!-- END: main -->