            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-19">
                            <input type="text" name="description" id="block-description" class="form-control txt" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="subject" class="col-sm-5 control-label">{LANG.subject}</label>
                        <div class="col-sm-19">
                            <input type="text" class="form-control txt" id="subject" name="subject">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="teacher_hometext" class="col-sm-5 control-label">Mô tả home:</label>
                        <div class="col-sm-19">
                            {edit_hometext}
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="teacher_bodytext" class="col-sm-5 control-label">Mô tả body:</label>
                        <div class="col-sm-19">
                            {edit_bodytext}
                        </div>
                    </div>
...
<div class="clearfix" style="text-align:center;">
    <button  class="btn btn-primary block-add-trigger pull-center">{LANG.block_add}</button>
</div>
<!-- END: main -->