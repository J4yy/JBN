		...
		<div class="panel-body">
			<div class="row">
				...
				<div class="col-xs-24 col-sm-18">
					...
					<!-- BEGIN: buy_offline -->
					<button type="button" class="btn btn-warning pull-right" data-toggle="modal" data-target="#buyOffline">{LANG.buy_offline}</button>

					<div id="buyOffline" class="modal fade" role="dialog">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									<button type="button" class="close" data-dismiss="modal">&times;</button>
									<h4 class="modal-title">{LANG.buy_offline}</h4>
								</div>
								<div class="modal-body">
									<div class="panel-group">
										...
										<div class="panel panel-default">
											<div class="panel-body">
												<img src="{SHOP.image}" alt="shop {SHOP.name}" class="img-responsive img-rounded" width="15%" style="float: left;">
												<span style="margin-left: 1rem;">{LANG.profile_company_name}: {SHOP.name}</span><br />
												<span style="margin-left: 1rem;">{LANG.detail_product_address}: {SHOP.address}</span><br />
												<span style="margin-left: 1rem;">{LANG.order_phone}: {SHOP.phone}</span>
											</div>
										</div>
										<!-- END: shop_loop -->
									</div>
